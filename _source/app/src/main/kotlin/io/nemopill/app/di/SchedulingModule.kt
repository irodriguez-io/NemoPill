 ...
 *
 * `@Binds` for [SchedulerPort] (the adapter is constructor-injected); `@Provides` for
 * [ClockPort] (its `:core` adapter is a plain class with no `@Inject`, keeping the shared
 * kernel free of Hilt) and for the [AlarmManager] system service.
 */
@Module
