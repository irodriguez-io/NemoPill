...
- How should the app behave if the device is off or the Reminder fails to fire — should the Dose roll over, be marked missed, or surface a 'late reminder' on next wake?
- Should Patients be able to log a Dose retroactively (e.g., "I took it 2 hours ago")? If yes, what's the time window?
